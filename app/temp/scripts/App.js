...
var _ThrowDice = __webpack_require__(2);

var _ThrowDice2 = _interopRequireDefault(_ThrowDice);
...
var Player = function () {
    function Player(number, name) {
        ...
        this.currentPlayerDiv = (0, _jquery2.default)('.currentPlayer');
        this.rollBtn = (0, _jquery2.default)('.btn__roll');
        this.dices = (0, _jquery2.default)(this.playerContainerName + ' .dice');
        ...
        this.throwDice = new _ThrowDice2.default();
    }
    ...
    _createClass(Player, [{
        ...
        value: function events() {
            ...
            this.dices.each(function () {
                (0, _jquery2.default)(this).click(self.toggleDice.bind(this));
            });
        }
    }, {
        key: 'toggleDice',
        value: function toggleDice() {
            (0, _jquery2.default)(this).toggleClass('dice--disabled');
        }
    }, {
        key: 'rollDice',
        ...
        key: 'buildMonument',
        value: function buildMonument(idx) {
...
Player.prototype.monumentLogger = function (idx) {
    return undefined.monuments[idx].name + undefined.monuments[idx].finished;
};
Player.prototype.achievementShower = function () {
    return undefined.achievements[0].researched;
};
...
var _rollDice = __webpack_require__(3);
...
var ThrowDice = function () {
    function ThrowDice() {
        _classCallCheck(this, ThrowDice);
    ...
    _createClass(ThrowDice, [{
        key: 'setDicesVisible',
        value: function setDicesVisible(diceCounter) {
            //MACHT SOVIEL BUTTONS SICHTBAR, WIE DIE ANZAHL DER WÜRFEL IS
            for (var i = 0; i < diceCounter; i++) {
                (0, _jquery2.default)('<button class="dice">' + diceCounter + '</button>').appendTo('.diceContainer');
            }
        }
    }, {
        key: 'roll',
        value: function roll() {
            return (0, _rollDice2.default)();
        }
    }, {
        key: 'throw',
        value: function _throw() {
            ...
            if (start == 1) {
                ...
                //         [doneButton release];
                for (var i = 1; i <= this.diceCounter; i++) {
...
var createPlayer = function createPlayer(number, s) {
    return new _Player2.default(number, s);
};
